...
#
# Но не всё так просто. ))) Перед открытием страницы включите отлавливание запроса в котором приходит информация о
# товарах и измените ответ так так, чтобы iPhone 17 Pro в попапе назывался "яблокофон 17 про"
#
